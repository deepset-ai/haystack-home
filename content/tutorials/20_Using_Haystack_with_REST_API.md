...
> You can find ready-made base files (*document-search.haystack-pipeline.yml* and *docker-compose.yml*) for this tutorial in the [document-search-demo](https://github.com/bilgeyucel/document-search-demo) repository. After following the instructions in the repository, you can proceed directly to the ['Indexing Files to Elasticsearch'](#indexing-files-to-elasticsearch) section of this tutorial and begin indexing your documents.
