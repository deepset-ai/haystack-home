---
layout: ambassadors
title: "Haystack Ambassador Program"
description: "Haystack Ambassadors are community members we recognize for the things they build, teach, and share - not for promoting us."
header: dark
footer: dark
...
status:
  ...
  items:
    - status: active
      label: "Active"
      description: "Shared at least one contribution last quarter."
    - status: at-risk
      label: "Inactive"
      description: "Quiet last quarter - we'll reach out to check in."
    - status: alumni
      label: "Alumni"
...
faq:
  ...
  items:
    ...
    - question: "How often are applications reviewed?"
      answer: "Quarterly. You'll hear back within a few weeks of each review cycle. If the timing doesn't work out, you're welcome to reapply."
