...
featured_image_caption: [Nesting tables in black and gold lacquer](https://commons.wikimedia.org/wiki/User:Chautard) by [Chautard](https://commons.wikimedia.org/wiki/User:Chautard).
...
Granted, most LLMs can output at least some SQL queries based on natural language input. But can they handle large, multi-table databases in a real-world setting? In other words, can they do the job of a data analyst? A small team here at deepset set out to answer that question. Over the course of three months, our intern [Michel Bartels](https://www.linkedin.com/in/michel-bartels/) and working student [Bijay Gurung](https://www.linkedin.com/in/bijay-gurung/) tried to find the best way to generate SQL queries on a real dataset.
...
!["Screenshot of shell with three tables, named 'Employment', 'Languages', and 'Coding activities', with three rows each. One of the values in the languages table is 'HTML/CSS'."](html-css.png)
...
!["Screenshot of the SQL query generated by the LLM."](experience-query.png)
...
!["Table returned in response to the query."](table.png)
